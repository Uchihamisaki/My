document.addEventListener("DOMContentLoaded", () => {
    ...
    // 1. جلب اللوحات الحالية من اسم مفتاح جديد لضمان تخطي الذاكرة القديمة التالفة
    let artworks = JSON.parse(localStorage.getItem('galleryArtworksList')) || [];
...
So ......I did not deny the cruelty of reality, yet I never surrendered to it.`;
    ...
    // 2. التحقق من وجود اللوحة الأساسية لتحديثها أو إضافتها لأول مرة
    ...
    // 3. حفظ البيانات المحدثة في مفتاح جديد آمن
    localStorage.setItem('galleryArtworksList', JSON.stringify(artworks));

    // 4. توليد الكروت وعرضها على الشاشة
